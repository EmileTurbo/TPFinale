...
namespace SlimUI.ModernMenu{
	public class UIMenuManager : MonoBehaviour {
        ...
        [Tooltip("The UI Panel that holds the PRINCIPES window tab")]
        public GameObject PanelPrincipes;
		...
		void DisablePanels(){
            ...
            PanelPrincipes.SetActive(false);
        ...
        public void PrincipesPanel()
        {
            DisablePanels();
            PanelPrincipes.SetActive(true);
            lineGame.SetActive(true);
        }
